...
class EditPlanService
{
     ...
     * @throws \Exception
     */
    public static function create(Credentials $credentials, EditPlan $editPlan)
    {
     ...
     * @return string
     */
    private static function request(Connection\Data $connection, $preApprovalRequestCode)
    {
        return $connection->buildDirectPreApprovalEditPlanRequestUrl($preApprovalRequestCode) . "?" . $connection->buildCredentialsQuery();
    }
